...
Observation normalization alone had also been tested earlier on the old
no-advantage-normalization config. It nearly matched the previous 1M best mean
late in training (`4410.0 +/- 24.8` vs. `4501.2 +/- 57.7`), but its final
evaluation was much noisier (`4037.6 +/- 1263.7`). That result was useful
because it showed observation normalization was not a standalone fix; it became
decisive only after advantage normalization and entropy pressure were retuned.
...
### Observation Normalization Alone Ablation
